...
class AIBlogWriter:
    ...
    async def generate_blog(self, topic: str, outline: Dict[str, Any], target_keywords: List[str], 
                          audience: str = "general", tone: str = "professional", word_count: int = 1200) -> Dict[str, str]:
        ...
        try:
            ...
            return self._parse_blog_response(response, outline)
        except Exception as e:
    ...
    return {
        ...
        "components": {
            ...
            "apis": {
                ...
                "serp_api": "configured" if SERP_API_KEY != "your-serpapi-key-here" else "not_configured"
            }
        }
    }
    ...
    try:
        ...
        return {
            ...
            "api_status": {
                ...
                "serp_api_configured": SERP_API_KEY != "your-serpapi-key-here"
            }
        }
    except Exception as e:
...
async def complete_seo_workflow(seed_keyword: str, audience: str = "general", word_count: int = 1200):
    ...
    try:
        ...
        # Step 1: Get keywords
        keyword_request = KeywordRequest(seed_keyword=seed_keyword, limit=30)
        ...
        topic_request = BlogTopicRequest(keywords=keywords_result["keywords"][:20])
        topics_result = await generate_blog_topics(topic_request)
        
        if not topics_result["blog_topics"]:
            raise HTTPException(status_code=400, detail="No viable blog topics generated")
        
        best_topic = topics_result["blog_topics"][0]
        workflow_results["steps"]["2_topics"] = {
            "status": "completed",
            "topics_generated": len(topics_result["blog_topics"]),
            "selected_topic": best_topic["topic_title"]
        }
